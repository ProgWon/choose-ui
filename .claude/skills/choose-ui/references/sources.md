...
Choose UI is an original synthesis. Its thresholds are practical defaults, not quotations or universal standards. Cite the source closest to the decision and defer to current product research or platform guidance when they conflict.
...
- [Apple HIG Pop-up Buttons](https://developer.apple.com/design/human-interface-guidelines/pop-up-buttons) — describes flat mutually exclusive options, useful defaults, and space constraints.

## Accessibility standards

- [WAI-ARIA Authoring Practices Guide](https://www.w3.org/WAI/ARIA/apg/) — interaction and keyboard patterns for custom widgets.
- [WCAG 2.2](https://www.w3.org/TR/WCAG22/) — normative accessibility requirements.

## Licensing note

Do not copy source documentation wholesale. Paraphrase guidance, link to the original, and preserve any attribution required by the source. The rules in this skill are released under this repository's license as an original decision framework.
